            ...
            <div className={styles.numbersGrid}>
                <div className={styles.numberItem}>
                    ...
                    <div className={styles.phoneLinks}>
                        <a href="https://wa.me/50670818306" target="_blank" rel="noopener noreferrer">7081-8306</a>
                        <a href="https://wa.me/50670332874" target="_blank" rel="noopener noreferrer">7033-2874</a>
                    </div>
                </div>
                <div className={styles.numberItem}>
                    <span className={styles.numberLabel}>Logística y Despacho</span>
                    <div className={styles.phoneLinks}>
                        <a href="https://wa.me/50671328432" target="_blank" rel="noopener noreferrer">7132-8432</a>
                    </div>
                </div>
            </div>
        </section>
